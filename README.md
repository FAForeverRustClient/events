...
is therefore left alone, whether the link is in its description or in its
location, which is where the signup address goes. The link is the marker rather
than the name: "Average Joe Olympics #6" contains neither the word tournament
nor the word cup.
